 ...
 */
extern const NSInteger G7PagingScrollViewUnknownNumberOfPages;
 ...
 * Value: 10
 */
extern const CGFloat G7PagingScrollViewDefaultPageMargin;

typedef enum {
	G7PagingScrollViewHorizontal = 0,
	G7PagingScrollViewVertical,
} G7PagingScrollViewType;


@protocol G7PagingScrollViewDataSource;
@protocol G7PagingScrollViewDelegate;
@protocol G7PagingScrollViewPage;
@class NIViewRecycler;

/**
 * The G7PagingScrollView class provides a UITableView-like interface for loading pages via a data
 * source.
 *
 * @ingroup NimbusPagingScrollView
 */

@interface G7PagingScrollView : UIView <UIScrollViewDelegate>

#pragma mark Data Source

- (void)reloadData;
@property (nonatomic, weak) id<G7PagingScrollViewDataSource> dataSource;
@property (nonatomic, weak) id<G7PagingScrollViewDelegate> delegate;

// It is highly recommended that you use this method to manage view recycling.
- (UIView<G7PagingScrollViewPage> *)dequeueReusablePageWithIdentifier:(NSString *)identifier;

#pragma mark State

- (UIView<G7PagingScrollViewPage> *)centerPageView;
...
@property (nonatomic) G7PagingScrollViewType type; // Default: NIPagingScrollViewHorizontal
...
/**
 * The delegate for G7PagingScrollView.
 *
 * @ingroup G7PagingScrollView
 */
@protocol G7PagingScrollViewDelegate <UIScrollViewDelegate>
@optional

#pragma mark Scrolling and Zooming /** @name [G7PhotoAlbumScrollViewDelegate] Scrolling and Zooming */

/**
 * The user is scrolling between two photos.
 */
- (void)pagingScrollViewDidScroll:(G7PagingScrollView *)pagingScrollView;

#pragma mark Changing Pages /** @name [G7PagingScrollViewDelegate] Changing Pages */
 ...
 * page index.
 */
- (void)pagingScrollViewWillChangePages:(G7PagingScrollView *)pagingScrollView;
 ...
 */
- (void)pagingScrollViewDidChangePages:(G7PagingScrollView *)pagingScrollView;
 ...
 * @ingroup NimbusPagingScrollView
 */
@protocol G7PagingScrollViewDataSource <NSObject>
@required
 ...
 * is called again.
 */
- (NSInteger)numberOfPagesInPagingScrollView:(G7PagingScrollView *)pagingScrollView;
 ...
 */
- (UIView<G7PagingScrollViewPage> *)pagingScrollView:(G7PagingScrollView *)pagingScrollView pageViewForIndex:(NSInteger)pageIndex;
 ...
 * @ingroup NimbusPagingScrollView
 */
@protocol G7PagingScrollViewPage <G7RecyclableView>
@required
