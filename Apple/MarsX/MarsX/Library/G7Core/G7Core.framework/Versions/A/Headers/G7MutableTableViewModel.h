 ...
 */
@protocol NIMutableTableViewModelDelegate <NSObject, G7TableViewModelDelegate>
 ...
 */
- (BOOL)tableViewModel:(G7MutableTableViewModel *)tableViewModel
 ...
 */
- (UITableViewRowAnimation)tableViewModel:(G7MutableTableViewModel *)tableViewModel
 ...
 * @ingroup TableViewModels
 */
@interface G7MutableTableViewModel : G7TableViewModel
