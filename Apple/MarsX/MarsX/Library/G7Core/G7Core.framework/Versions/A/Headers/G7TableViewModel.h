...
typedef UITableViewCell* (^G7TableViewModelCellForIndexPathBlock)(UITableView* tableView, NSIndexPath* indexPath, id object);
#endif // #if NS_BLOCKS_AVAILABLE

@protocol G7TableViewModelDelegate;


#pragma mark Sectioned Array Objects

// Classes used when creating G7TableViewModels.
@class G7TableViewModelFooter;  // Provides the information for a footer.

typedef enum {
	G7TableViewModelSectionIndexNone, // Displays no section index.
	G7TableViewModelSectionIndexDynamic, // Generates a section index from the first letters of the section titles.
	G7TableViewModelSectionIndexAlphabetical, // Generates an alphabetical section index.
} G7TableViewModelSectionIndex;
 ...
 */
@interface G7TableViewModel : NSObject <G7ActionsDataSource, G7TableViewDataSource>

#pragma mark Creating Table View Models

// Designated initializer.
- (id)initWithDelegate:(id<G7TableViewModelDelegate>)delegate;
- (id)initWithListArray:(NSArray *)sectionedArray delegate:(id<G7TableViewModelDelegate>)delegate;
...
- (id)initWithSectionedArray:(NSArray *)sectionedArray delegate:(id<G7TableViewModelDelegate>)delegate;
...
- (void)setSectionIndexType:(G7TableViewModelSectionIndex)sectionIndexType showsSearch:(BOOL)showsSearch showsSummary:(BOOL)showsSummary;

@property (nonatomic, readonly, assign) G7TableViewModelSectionIndex sectionIndexType; // Default: NITableViewModelSectionIndexNone
...
@property (nonatomic, weak) id<G7TableViewModelDelegate> delegate;
...
@property (nonatomic, copy) G7TableViewModelCellForIndexPathBlock createCellBlock;
#endif // #if NS_BLOCKS_AVAILABLE
...
/**
 * A protocol for G7TableViewModel to fetch rows to be displayed for the table view.
 *
 * @ingroup TableViewModels
 */
@protocol G7TableViewModelDelegate <NSObject>
 ...
 */
- (UITableViewCell *)tableViewModel: (G7TableViewModel *)tableViewModel
 ...
 *
 * Meant to be used in a sectioned array for G7TableViewModel.
 *
 * <h3>Example</h3>
 *
 * @code
 *  [G7TableViewModelFooter footerWithTitle:@"Footer"]
 * @endcode
 */
@interface G7TableViewModelFooter : NSObject
