...
class G7AppDetailReqHandlers(G7APIReqHandler):
    '''
        首页
    '''
    def get(self):
...
# 查询不到
        ...
        jsonData['icon']=project1.icon.url
...
# 解析产品里面的所有打包记录
        ...
        for i in range(0,len(applications)):
            ...
            appJson['dsymFile']=app.dsymFile.url
            appJson['file']=app.file.url
            appJson['icon']=app.icon.url
