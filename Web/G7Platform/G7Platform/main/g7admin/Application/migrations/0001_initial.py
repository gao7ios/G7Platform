    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('channel', models.IntegerField(default=0, verbose_name='渠道')),
                ...
                ('icon', models.ImageField(blank=True, default='/media/application/icon/default_icon.png', upload_to='application/icon/', verbose_name='图标')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, default='', null=True, verbose_name='产品简介')),
