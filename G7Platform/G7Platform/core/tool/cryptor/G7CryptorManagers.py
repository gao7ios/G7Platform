...
class G7CryptorManager:
    ...
    def getB64DecryptText(text):
        ...
        if cryptor_type == cryptor_types[G7CryptorType.base64]:
            ...
            decryptBytes = G7CryptorManager.desBase64_B64DecodeText(cryptor_text)
    ...
    def getTextEncryptB64(text, cryptror_type):
        ...
        if cryptror_type == G7CryptorType.base64:
            ...
            encryptBytes = bytes(prefix,"utf-8")+G7CryptorManager.desBase64_TextEncodeB64(text)
        ...
        return G7CryptorManager.bytesToString(encryptBytes)
